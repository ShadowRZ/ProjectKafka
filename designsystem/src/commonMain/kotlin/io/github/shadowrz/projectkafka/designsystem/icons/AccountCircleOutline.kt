...
val KafkaIcons.AccountCircleOutline: ImageVector
    get() {
        if (_AccountCircleOutline != null) {
            return _AccountCircleOutline!!
        }
        _AccountCircleOutline =
            ImageVector.Builder(
                ...
                .apply {
                    path(fill = SolidColor(Color.Black)) {
                        ...
                        quadToRelative(1.325f, 0f, 2.5f, -0.387f)
                        reflectiveQuadToRelative(2.15f, -1.113f)
                        quadToRelative(-0.975f, -0.725f, -2.15f, -1.112f)
                        reflectiveQuadTo(12f, 17f)
                        reflectiveQuadToRelative(-2.5f, 0.388f)
                        reflectiveQuadTo(7.35f, 18.5f)
                        quadToRelative(0.975f, 0.725f, 2.15f, 1.113f)
                        reflectiveQuadTo(12f, 20f)
                        moveToRelative(0f, -9f)
                        quadToRelative(0.65f, 0f, 1.075f, -0.425f)
                        reflectiveQuadTo(13.5f, 9.5f)
                        reflectiveQuadToRelative(-0.425f, -1.075f)
                        reflectiveQuadTo(12f, 8f)
                        reflectiveQuadToRelative(-1.075f, 0.425f)
...
@Suppress("ObjectPropertyName") private var _AccountCircleOutline: ImageVector? = null
