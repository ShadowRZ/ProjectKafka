...
val MaterialIcons.GroupsOutline: ImageVector
    get() {
        if (_GroupsOutline != null) {
            return _GroupsOutline!!
        }
        _GroupsOutline = ImageVector.Builder(
            name = "GroupsOutline",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                moveTo(8.125f, 16f)
                lineTo(15.9f, 16f)
                quadToRelative(-0.25f, -0.5f, -1.388f, -0.875f)
                reflectiveQuadTo(12f, 14.75f)
                reflectiveQuadToRelative(-2.512f, 0.375f)
                reflectiveQuadTo(8.125f, 16f)
                moveTo(4f, 13f)
...
private var _GroupsOutline: ImageVector? = null
